...
NestedNameSpecifier *
ASTContext::getNestedNameSpecifierImpl(
                                 NestedNameSpecifier *Pfx,  bool HasTemplateKW,
                                 NestedNameSpecifier::StorageType Spec) const {
  llvm::FoldingSetNodeID ID;
  NestedNameSpecifier::Profile(ID, Pfx, HasTemplateKW, Spec);
  void *InsertPos = nullptr;
  auto *NNS = NestedNameSpecifiers.FindNodeOrInsertPos(ID, InsertPos);
  if (!NNS) {
    NNS = new (*this, alignof(NestedNameSpecifier))
        NestedNameSpecifier(Pfx, HasTemplateKW, Spec);
...
ASTContext::getNestedNameSpecifier(NestedNameSpecifier *Prefix,
  ...
  return getNestedNameSpecifierImpl(
      Prefix, false, const_cast<IdentifierInfo *>(II));
}

NestedNameSpecifier *
ASTContext::getNestedNameSpecifier(NestedNameSpecifier *Prefix,
                                   const Type *T,
                                   bool HasTemplateKW) const {
  assert(T && "Type cannot be NULL");
  return getNestedNameSpecifierImpl(
      Prefix, HasTemplateKW, const_cast<Type *>(T));
}
...
ASTContext::getNestedNameSpecifier(NestedNameSpecifier *Prefix,
  ...
  return getNestedNameSpecifierImpl(
      Prefix, false, const_cast<NamespaceDecl *>(ND));
}
...
ASTContext::getNestedNameSpecifier(NestedNameSpecifier *Prefix,
  ...
  assert((!Prefix ||
         ...
         "Broken nested name specifier");
  return getNestedNameSpecifierImpl(
      Prefix, false, const_cast<NamespaceAliasDecl *>(NAD));
}
...
ASTContext::getSuperNestedNameSpecifier(const CXXRecordDecl *RD) const {
  ...
  return getNestedNameSpecifierImpl(
      nullptr, false, const_cast<CXXRecordDecl *>(RD));
}
...
ASTContext::getGlobalNestedNameSpecifier() const {
  if (!GlobalNestedNameSpecifier)
    GlobalNestedNameSpecifier = new (*this, alignof(NestedNameSpecifier))
        NestedNameSpecifier(nullptr, false, nullptr);
