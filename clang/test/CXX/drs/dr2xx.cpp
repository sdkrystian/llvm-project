...
namespace dr285 { // dr285: yes
  ...
  //   expected-note@#dr285-f-int-T {{function template 'dr285::f' matches specialization [with T = int]}}
  //   expected-note@#dr285-f-T-int {{function template 'dr285::f' matches specialization [with T = int]}}
}
